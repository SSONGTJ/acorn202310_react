...
export default function Cafe(){
        ...
        */
        ...
        // 검색 select , input 요소에 변화가 생겼을때 호출되는 함수 
        const handleSearchChange = (e) => {
            setSearchState({
                ...searchState,
                [e.target.name]:e.target.value
            })
            //검색 버튼 누르지 않고 바로 검색되기를 원하면 여기서 updateNavigate() 함수를 호출해 준다.
            //updateNavigate()
        }
    ...
    return (
        <>
            ...
            <select id="search" name="condition" value={searchState.condition} 
            ...
            <input type="text" placeholder="검색어..." name="keyword" value={searchState.keyword} 
                onChange={handleSearchChange}/>
